...
Update_Scripts() {
  ...
  curl -H "Accept-Encoding: identity" -L -o start.sh https://raw.githubusercontent.com/f43r05/MinecraftBedrockServer/AcePlaceMC/start.sh
  chmod +x start.sh
  ...
  curl -H "Accept-Encoding: identity" -L -o stop.sh https://raw.githubusercontent.com/f43r05/MinecraftBedrockServer/AcePlaceMC/stop.sh
  chmod +x stop.sh
  ...
  curl -H "Accept-Encoding: identity" -L -o restart.sh https://raw.githubusercontent.com/f43r05/MinecraftBedrockServer/AcePlaceMC/restart.sh
  chmod +x restart.sh
  ...
  curl -H "Accept-Encoding: identity" -L -o fixpermissions.sh https://raw.githubusercontent.com/f43r05/MinecraftBedrockServer/AcePlaceMC/fixpermissions.sh
  ...
  curl -H "Accept-Encoding: identity" -L -o revert.sh https://raw.githubusercontent.com/f43r05/MinecraftBedrockServer/AcePlaceMC/revert.sh
  chmod +x revert.sh
  ...
  curl -H "Accept-Encoding: identity" -L -o clean.sh https://raw.githubusercontent.com/f43r05/MinecraftBedrockServer/AcePlaceMC/clean.sh
  chmod +x clean.sh
  ...
  curl -H "Accept-Encoding: identity" -L -o update.sh https://raw.githubusercontent.com/f43r05/MinecraftBedrockServer/AcePlaceMC/update.sh
  chmod +x update.sh
...
Update_Service() {
  ...
  sudo curl -H "Accept-Encoding: identity" -L -o /etc/systemd/system/$ServerName.service https://raw.githubusercontent.com/f43r05/MinecraftBedrockServer/AcePlaceMC/minecraftbe.service
...
Check_Architecture() {
  ...
  if [[ "$CPUArch" == *"aarch"* ]]; then
    ...
    curl -H "Accept-Encoding: identity" -L -o depends.zip https://raw.githubusercontent.com/f43r05/MinecraftBedrockServer/AcePlaceMC/depends.zip
    unzip depends.zip
    sudo mkdir /lib64
